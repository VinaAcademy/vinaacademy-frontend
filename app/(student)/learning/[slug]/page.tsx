...
const CoursePage: FC<CoursePageProps> = ({ params }) => {
    ...
    return (
      <div className="flex flex-col h-screen bg-white text-black">
        ...
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <p className="mb-6">
            Khóa học bạn đang tìm kiếm có thể đã bị xóa hoặc không tồn tại.
          </p>
          <Link
            href="/my-courses"
  ...
  const countLecturesByType = (type: string) => {
    return course.sections
      ...
      .filter((lecture) => lecture.type === type).length
  }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      {course && (
        <ChatbotContextUpdater courseId={course.id} courseName={course.title} />
      )}
      <LearningHeader
            ...
            <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-3">
              <div className="flex items-center text-gray-600 text-sm sm:text-base">
                ...
                <span className="truncate">
                  {formatTotalDuration(course.sections)}
                </span>
              </div>
              <div className="flex items-center text-gray-600 text-sm sm:text-base">
              ...
              <div className="flex items-center text-gray-600 text-sm sm:text-base">
                ...
                <span>
                  Cập nhật: {formatLastUpdated(apiResponse?.updatedDate)}
                </span>
              </div>
            </div>
                  ...
                  <div className="flex items-center min-w-0">
                    ...
                    <div className="ml-2 sm:ml-3 min-w-0">
                      <p className="font-medium text-gray-800 text-sm sm:text-base truncate">
                        {course.currentLecture.title}
                      </p>
                      <p className="text-xs sm:text-sm text-gray-500">
                        {course.currentLecture.duration}
                      </p>
                    </div>
                  </div>
