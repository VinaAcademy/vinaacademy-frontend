  ...
  try {
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <article className="lg:w-2/3">
                  ...
                  <section className="bg-white border rounded-lg p-6 mb-8">
                    ...
                    <ProsConsSummary courseId={course.id} limit={10} />
                  </section>

                  {/* Reviews with Sentiment Filter */}
                  <section className="bg-white border rounded-lg p-6 mb-8">
                    <h2 className="text-2xl font-bold mb-6">
                      Đánh giá từ học viên
                    </h2>
                    <SentimentFilter courseId={course.id} />
                  </section>

                  {/* Traditional Review Area */}
                  <section className="bg-white border rounded-lg p-6 mb-8">
                    <ReviewsArea courseId={course.id} mainPage={true} />
                  </section>
                </article>
    ...
    return (
      <div className="text-center text-xl text-red-500 p-10">
        Lỗi khi tải khóa học! Vui lòng thử lại sau.
      </div>
    )
  }
}
