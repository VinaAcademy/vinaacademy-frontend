...
const RecentCoursesSection = () => {
  ...
  if (!isAuthenticated || (!isLoading && filteredCourses.length === 0)) {
    return null
  }
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 px-1 sm:px-2">
        {isLoading ? (
          ...
          filteredCourses.map((course: LearningCourse) => (
            <Link
              key={course.slug}
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mb-1">
                    <span className="flex items-center gap-1">
                      ...
                      {course.instructor}{' '}
                      {/* Hiển thị thời gian truy cập đã được định dạng */}
                    </span>
                  </p>
                  <div className="mt-1">
                    ...
                    <div className="flex justify-between mt-1">
                      ...
                      <span className="text-xs text-blue-600">
                        {Number(course.progress).toFixed(0)}%
                      </span>
                    </div>
                  </div>
                </div>
