          ...
          prev.map((reply) =>
            reply.id === replyId
              ? {
                  ...
                  favoriteCount: reply.favoriteCount + (isLiked ? -1 : 1),
                }
              : reply,
          ),
        )
        ...
        <div className="border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          <div className="p-3 sm:p-4">
            ...
            <div className="flex items-center text-xs sm:text-sm text-gray-500 space-x-3 sm:space-x-4">
              <button
                onClick={() =>
                  onToggleLike(comment.id, comment.likedByCurrentUser)
                }
              ...
              {comment.replyCount > 0 && (
                ...
                >
                  ...
                  <span>
                    {expandedReplies ? 'Ẩn' : 'Xem'} {comment.replyCount} phản
                    hồi
                  </span>
                </button>
              )}
                  ...
                  <div className="flex justify-center pt-2">
                    ...
                    >
                      {loadingMoreReplies ? (
                        ...
                        <span>
                          Tải thêm {Math.min(10, getRemainingRepliesCount())}{' '}
                          phản hồi
