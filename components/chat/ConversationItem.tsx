        ...
        case 'FILE':
          return (
            <span className="flex items-center gap-1">
              ...
              {senderPrefix}
              {lastMessage.fileName || 'Tệp đính kèm'}
            </span>
          )
        default:
    ...
    return (
      <div
        ...
        className={cn(
          ...
          'active:scale-[0.99]',
          unreadChatCount > 0 &&
            'bg-gradient-to-r from-cyan-50/60 to-transparent border-l-4 border-l-cyan-500',
        )}
      >
        {/* Hover effect overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/0 to-sky-500/0 group-hover:from-cyan-500/5 group-hover:to-sky-500/5 transition-all duration-300 pointer-events-none"></div>
        ...
        <div className="relative flex-shrink-0 z-10">
          ...
          />
          {/* Online indicator */}
          {!isGroup && <OnlineIndicator isOnline={isOnline} size={12} />}
        </div>
        ...
        <div className="flex-1 min-w-0 z-10">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {unreadChatCount > 0 && (
              <Badge className="flex-shrink-0 h-5 min-w-[20px] px-1.5 flex items-center justify-center rounded-full bg-gradient-to-r from-cyan-600 to-sky-500 hover:from-cyan-600 hover:to-sky-500 text-white text-xs font-bold shadow-md animate-in zoom-in duration-300">
