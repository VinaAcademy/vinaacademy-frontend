  ...
  return (
    ...
    >
      ...
      {showTimestamp && (
        <div className="flex items-center justify-center my-6">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-sky-500/20 blur-xl rounded-full" />
            <div className="relative bg-gradient-to-r from-cyan-50 to-sky-50 dark:from-cyan-950/50 dark:to-sky-950/50 px-4 py-1.5 rounded-full text-xs font-medium text-gray-700 dark:text-gray-300 shadow-sm border border-cyan-200/50 dark:border-cyan-800/50">
      ...
      >
        ...
        {!isOwn && (
          <Avatar
            src={getImageUrl(sender?.avatarUrl || '/images/default-avatar.png')}
