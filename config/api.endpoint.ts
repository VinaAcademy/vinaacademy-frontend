...
export const API_ENDPOINTS = {
    ...
    COURSE: {
        ...
        INSTRUCTOR_PUBLISHED: (instructorId: string) => `/courses/instructor/${instructorId}/published`,
        INSTRUCTOR_PUBLISHED_COUNT: (instructorId: string) => `/courses/instructor/${instructorId}/published/count`,
    },
    ...
    QUIZ_INSTRUCTOR: {
        ...
        UPDATE_QUESTION: (questionId: string) => `/instructor/quiz/questions/${questionId}`,
        DELETE_QUESTION: (questionId: string) => `/instructor/quiz/questions/${questionId}`,

        // Answer management
        CREATE_ANSWER: (questionId: string) => `/instructor/quiz/questions/${questionId}/answers`,
    ...
    ENROLLMENT: {
        ...
        UPDATE_STATUS: (enrollmentId: number) => `/enrollments/${enrollmentId}/status`,
    },
    ...
    STUDENT_PROGRESS: {
        ...
        BY_COURSE: (courseId: string) => `/instructor/courses/${courseId}/students-progress`,
    },
    ...
    COURSE_REVIEW: {
        ...
        USER_REVIEW: (courseId: string) => `/course-reviews/user/course/${courseId}`,
        STATISTICS: (courseId: string) => `/course-reviews/statistics/course/${courseId}`,
 ...
 */
export const buildSort = (sortBy: string, sortDirection: 'asc' | 'desc'): string => {
