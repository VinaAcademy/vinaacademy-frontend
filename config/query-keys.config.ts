...
const QUIZ_KEYS = {
  ...
  questions: (quizId: string) =>
    [...QUIZ_KEYS.quiz(quizId), 'questions'] as const,
  ...
  submissions: (quizId: string) =>
    [...QUIZ_KEYS.quiz(quizId), 'submissions'] as const,
} as const
...
const ENROLLMENT_KEYS = {
  ...
  byCourse: (courseId: string) =>
    [...ENROLLMENT_KEYS.all, 'course', courseId] as const,
} as const
...
const VIDEO_KEYS = {
  ...
  progress: (videoId: string) =>
    [...VIDEO_KEYS.all, 'progress', videoId] as const,
} as const
...
const DISCUSSION_KEYS = {
  ...
  thread: (discussionId: string) =>
    [...DISCUSSION_KEYS.all, 'thread', discussionId] as const,
} as const
...
const PROGRESS_KEYS = {
  ...
  // Course progress
  byCourse: (courseId: string) =>
    [...PROGRESS_KEYS.all, 'course', courseId] as const,

  // Lesson progress
  byLesson: (lessonId: string) =>
    [...PROGRESS_KEYS.all, 'lesson', lessonId] as const,
} as const
...
const INSTRUCTOR_KEYS = {
  ...
  // Single instructor
  byId: (instructorId: string) =>
    [...INSTRUCTOR_KEYS.all, instructorId] as const,

  // Instructor courses
  courses: (instructorId: string) =>
    [...INSTRUCTOR_KEYS.all, instructorId, 'courses'] as const,

  // Instructor earnings
  earnings: (instructorId: string) =>
    [...INSTRUCTOR_KEYS.all, instructorId, 'earnings'] as const,

  // Instructor students
  students: (instructorId: string) =>
    [...INSTRUCTOR_KEYS.all, instructorId, 'students'] as const,
} as const
